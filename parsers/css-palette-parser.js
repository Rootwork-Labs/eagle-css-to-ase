(function attachCssToAseCssParser(root) {
const colorUtils = root.CssToAseColorUtils
  || (typeof module !== "undefined" ? require("./color-utils") : null);
if (!colorUtils) {
  throw new Error("CssToAseColorUtils must load before css-palette-parser.js");
}
const { parseColorValue, titleCaseFamily } = colorUtils;
