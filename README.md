...
Parser support matches [eagle-palette-viewer](https://github.com/Rootwork-Labs/eagle-palette-viewer): design-token ramps (`--color-family-shade`, `--family-shade`), flat exports, and related CSS palette formats.
...
Pair with [eagle-palette-viewer](https://github.com/Rootwork-Labs/eagle-palette-viewer) to preview `.ase` files directly in Eagle.
